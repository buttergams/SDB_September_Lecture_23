...
const presidentData = {
    totalPresidents: function () {
        return presidents.length;
    },

    livingPresidents: function () {
        return presidents.filter(president => president.passed === undefined);
    },

    deadPresidents: function () {
        return presidents.filter(president => president.passed !== undefined);
    },

    ageAtDeath: function () {
        this.deadPresidents().forEach(president => {
            const ageAtDeath = president.passed - president.year;
            console.log(`${president.first} ${president.last} was ${ageAtDeath} years old when they died.`);
        });
    }
};

console.log(`We have had ${presidentData.totalPresidents()} presidents.`);

console.log("Alive Presidents:", presidentData.livingPresidents());

console.log("Dead Presidents:", presidentData.deadPresidents());
presidentData.ageAtDeath();
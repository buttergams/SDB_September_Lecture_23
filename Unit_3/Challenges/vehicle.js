...
class Vehicle {
    ...
    turnOn() {
        this.engine_on = true;
        console.log(`${this.color} ${this.make} ${this.model}: Running!`);
    }
    
    turnOff() {
        this.engine_on = false;
        console.log(`${this.color} ${this.make} ${this.model}: Not running.`);
    }
}
const myVehicle = new Vehicle('Subaru', 'Outback', 4, 'Black');
myVehicle.turnOn();
myVehicle.turnOff();
...
class Sedan extends Vehicle{
    ...
    static parkedCar(make, model, no_wheels, color) {
